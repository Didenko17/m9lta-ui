<script lang="ts">
    ...
    import snippet from "../snippets/input";
    ...
    const events: EventsTableRow[] = [
        ...
        },
        {
            name: "input",
            params: "e: Event",
            description: "Works on input value."
        },
    ]
</script>
